var mouseEvent = "empty";
    ...
    function my_mouseup(parameter)
    {

    }

    function my_mouseleave(parameter)
    {
    ...
    */
    ...
    function my_mousemove(e)
    {
        ...
        current_position_of_mouse_x = e.clientX - canvas.offsetTop;

        current_position_of_mouse_x = e.clientY - canvas.offsetLeft;
        current_position_of_mouse_x = e.clientY - canvas.offsetRight;
